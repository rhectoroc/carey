...
- **Correcciones Mobile Post-Audit:** Fix de visualización del vídeo en Hero (altura corregida) y corrección de la grilla de TravelSearch para alineación perfecta en móviles. (Estado: Completado)
