...
- **Correcciones Mobile Post-Audit:** Fix de visualización del vídeo en Hero (rediseño de posicionamiento CSS y z-index) y corrección de la grilla de TravelSearch. Ajuste de margen en la barra de búsqueda para mejorar la legibilidad de los subtítulos en móviles. (Estado: Completado)
