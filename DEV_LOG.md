...
- **Correcciones Mobile Post-Audit:** Refactorización profunda de Hero.tsx para forzar muting vía JS (evitando bloqueos de autoplay) y reestructuración de z-indexing (0 a 2) para asegurar visibilidad del vídeo por encima de fondos de body pero debajo de overlay y contenido. (Estado: Completado)
