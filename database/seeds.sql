...
-- 3. Tours
INSERT INTO tours (name, slug, destination_id, type, duration, duration_days, price) VALUES 
('Full Day Isla de Coche', 'full-day-coche', (SELECT id FROM destinations WHERE slug='isla-margarita'), 'Playa', '8 horas', 1, 45.00),
('Jeep Safari 4x4', 'jeep-safari-margarita', (SELECT id FROM destinations WHERE slug='isla-margarita'), 'Aventura', '6 horas', 1, 60.00),
('Expedición Salto Ángel', 'expedicion-salto-angel', (SELECT id FROM destinations WHERE slug='canaima'), 'Aventura', '3 días', 3, 500.00),
('Catamarán a Noronky', 'catamaran-noronky', (SELECT id FROM destinations WHERE slug='los-roques'), 'Navegación', '7 horas', 1, 90.00);
